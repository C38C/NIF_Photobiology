...
for n_view, view in enumerate(viewnames):
    ...
    for index in range(365):
        eemel_8760_electric[index].extend( [0.0] * len(eemel_8760[index])) 
        eemel_8760_screen[index].extend( [0.0] * len(eemel_8760[index])) 
    ...
    for d_sim in range(365):
        ...
        person.simulate_day(E_daylight, S = S2)
