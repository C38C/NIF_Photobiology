...
subfolder = "s3_daylight_electric_screen_dimming" 
label_add = ""
...
for sd in CCT_2800:
    if sd.type == 'view':
        ...
        Eemel_2800CCT_view_half.append(Eemel / 2.0)
...
for n_view, view in enumerate(viewnames):
    ...
    for index in range(365):
        ...
        eemel_8760_electric[index].extend( [Eemel_6500CCT_view[n_view]] *  int(12 * 60 * 60 / 20)) 
        eemel_8760_electric[index].extend( [Eemel_2800CCT_view[n_view]] *  int(3 * 60 * 60 / 20)) 
        eemel_8760_electric[index].extend( [Eemel_2800CCT_view_half[n_view]] *  int(3 * 60 * 60 / 20)) 
        eemel_8760_screen[index].extend( [0.0] * int(18 * 60 * 60 / 20)) 
        eemel_8760_screen[index].extend( [E_mon_6500] * int(3 * 60 * 60 / 20))
        eemel_8760_screen[index].extend( [E_mon_1900] * int(3 * 60 * 60 / 20))
