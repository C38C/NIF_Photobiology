...
d_wl = 20.0 # delta wavelength in input source from ALFA calc
...
def read_pseudoalfa_file(path):
    ...
    with open(path, 'r') as f:
        ...
        wl_values = [int(i) for i in header_parts[10:]]
        ...
        while True: # read until blank line
            ...
            eml = float(parts[7])
            name = parts[0]
            xyz_dir = [float(i) for i in parts[1:7]]
            sensor_spectra = [float(i) for i in parts[10:]]
