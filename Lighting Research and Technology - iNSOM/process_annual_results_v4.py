"""
Code to produce visualization file for Athina ----

- v1 - 19 June 2021 - 6 July 2021

- v2 - 15 July 2021

- v3
    - Cumulative phase shift per season

- v4
    - Updates for Lighting Research & Technology revisions. 
"""

import statistics as stats

views = ["L1", "L2", "L3", "cL1", "cL2", "cL3", "cR1", "cR2", "cR3", "R1", "R2", "R3"]


dir_day = '.\\day\\'

subfolder = "s1_daylight_only"
...
# season,x,y,z,dx,dy,dz,phaseshift,melsuppress,kss_morning,kss_afternoon,kss_evening,vpvtrt_morning,vpvtrt_afternoon,vpvtrt_evening
# spring,0,0,1.2,0,0,-1,-2.36,11.5,2.8,3.9,3.4,297.9,236.3,311.9
# summer,0,0,1.2,0,0,-1,-0.24,3.9,3.0,3.4,4.0,243.8,378.3,237.7
# fall,0,0,1.2,0,0,-1,-0.58,4.5,2.9,3.0,3.5,209.9,355.2,364.7
# winter,0,0,1.2,0,0,-1,-2.23,10.9,2.8,2.8,3.0,220.6,267.1,360.8
...
winter_indices.extend( range(8, day_index(2,28) + 1, 1) ) # skip first week of winter for entrainment

class metrics:
    """Contains our annual metrics for display!"""
...
with open(fname_pre + sleep_post + '_display.csv', 'w') as f_w:
...
for view in views:
    ...
    fname = dir_day + fname_pre + sleep_post + "_%s_corrected.csv" % view
    ...
    with open(fname_pre + sleep_post + '_display.csv', 'a') as f_w:
